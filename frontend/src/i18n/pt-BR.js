const ptBR = {
  ...
  entities: {
    etudiant: {
      ...
      label: 'Etudiants',
      menu: 'Etudiants',
      exporterFileName: 'Etudiant_exportados',
      list: {
        menu: 'Etudiants',
        title: 'Etudiants',
      },
      create: {
        success: 'Etudiant salvo com sucesso',
      },
      update: {
        success: 'Etudiant salvo com sucesso',
      },
      destroy: {
        success: 'Etudiant deletado com sucesso',
      },
      destroyAll: {
        success: 'Etudiant(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Etudiant',
      },
      fields: {
        id: 'Id',
        'nom': 'Nom',
        ...
        'entreeenfranceRange': 'Entree en France',
        'entreeenfrance': 'Entree en France',
        'paysobtentionbac': 'Pays obtention BAC',
        'metiervise': 'Metier visé',
        'dateentreechezdaradjaRange': 'Date entree chez Daradja',
        'dateentreechezdaradja': 'Date entree chez Daradja',
      ...
      view: {
        title: 'Visualizar Etudiant',
      },
      importer: {
        title: 'Importar Etudiants',
        fileName: 'etudiant_template_importacao',
        hint:
  ...
  roles: {
    ...
    etudiantEditor: {
      label: 'Editor de Etudiants',
      description: 'Acesso de edição aos Etudiants',
    },
    etudiantViewer: {
      label: 'Visualizador de Etudiants',
      description: 'Acesso de visualização aos Etudiants',
    },
    bookingEditor: {
