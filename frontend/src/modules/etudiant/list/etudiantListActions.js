...
import exporterFields from 'modules/etudiant/list/etudiantListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'ETUDIANT_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await EtudiantService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.etudiant.exporterFileName'),
