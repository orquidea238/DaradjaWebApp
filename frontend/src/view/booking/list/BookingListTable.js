...
import EtudiantListItem from 'view/etudiant/list/EtudiantListItem';
...
class BookingListTable extends Component {
  ...
  columns = [
    ...
    fields.etudiant.forTable({
      render: (value) => <EtudiantListItem value={value} />,
    }),
    fields.debut.forTable(),
    fields.fin.forTable(),
    fields.commentaires.forTable(),
