...
import selectors from 'modules/etudiant/etudiantSelectors';

class EtudiantViewItem extends Component {
  valueAsArray = () => {
...
export default connect(select)(EtudiantViewItem);
