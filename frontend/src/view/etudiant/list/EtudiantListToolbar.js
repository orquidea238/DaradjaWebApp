...
class EtudiantToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=etudiant">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: etudiantSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: etudiantSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(EtudiantToolbar);
